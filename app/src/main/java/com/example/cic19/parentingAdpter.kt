...
class parentingAdpter : ArrayAdapter<String?> {
    var con: Context
    var images: IntArray
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        var holder: parenting_viewholder? = null
        ...
        if (singleItem == null) {
            ...
            holder = parenting_viewholder(singleItem)
            ...
            holder = singleItem.tag as parenting_viewholder
        }
